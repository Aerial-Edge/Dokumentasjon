...
class UdpProtocol:
    ...
    def __init__(self):
        """
        Initializer function for the UdpProtocol class.
    ...
    def connection_made(self, transport):
        ...
        :param transport: The transport layer responsible for the connection.
        """
    ...
    def connection_lost(self, transport):
        ...
        Currently, it only prints a message to the console.
        :param transport: The transport layer that lost the connection.
        """
...
class Qualisys_node(Node):
    """
    A class that extends the Node class from rclpy.node.
    This node is responsible for communicating with a Qualisys system and publishing the drone pose.
    """

    def __init__(self):
        """
        Initializer for the Qualisys_node class.
        Creates a publisher for DronePose messages on the 'drone_pose' topic.
        """
    ...
    def talker(self, data):
        """
        Function for publishing data to the 'drone_pose' topic.
    ...
    def create_msg(self,x,y,z,v_x,v_y,v_z,a_x,a_y,a_z,yaw,v_yaw,freq,full_msg):
        """
        Function to create a new DronePose message and store the previous one for calculations.
        It will not publish the message if full_msg is False.
        :param x: The x position.
        :param y: The y position.
        :param z: The z position.
        :param v_x: The x velocity.
        :param v_y: The y velocity.
        :param v_z: The z velocity.
        :param a_x: The x acceleration.
        :param a_y: The y acceleration.
        :param a_z: The z acceleration.
        :param yaw: The yaw.
        :param v_yaw: The yaw velocity.
        :param freq: The frequency of the data.
        :param full_msg: Whether the message is complete and should be published.
        :return: A tuple containing whether the message was published and whether the position was saved.
        """
    ...
    def calc(self,position,rot,freq):
        """
        Function to calculate the real frequency and call calculate_vel_a() with the position, frequency, and yaw.
        :param position: The current position.
    ...
    def create_body_index(self, xml_string):
        ...
        :param xml_string: The xml string containing the 6-DOF settings.
        :return: A dictionary mapping body names to indices.
        """
    ...
    def get_freq(self, xml_string):
        ...
        :param xml_string: The xml string containing the frequency.
    ...
    async def qtmMain(self):
        ...
        This function handles the connection to the Qualisys server and the streaming of data.
        """
        ...
        def on_packet(packet): #This function will be called whenever a new packet arrives
            """
            This function is called whenever a new packet arrives from the Qualisys system.

            :param packet: The incoming data packet from the Qualisys system.
...
def main(args=None):
    """
    Main function for the Qualisys node.
    This function initializes the node, creates an instance of the Qualisys_node class,
    and runs the qtmMain asynchronous function in a loop.
    :param args: The command line arguments. Defaults to None.
    """
    rclpy.init(args=args)

    qualisys_node = Qualisys_node()
    
    # Create a new event loop
    loop = asyncio.get_event_loop()
    
    # Run the qtmMain function of the qualisys_node instance in a loop
    loop.run_until_complete(qualisys_node.qtmMain())
    
    rclpy.spin(qualisys_node)

    qualisys_node.destroy_node()
    rclpy.shutdown()
...
if __name__ == '__main__':
    ...
    This is where the main function is called if the script is run directly (and not imported as a module).
    """
    main()